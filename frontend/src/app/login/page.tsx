    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4 text-gray-900">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">З поверненням</h1>
          <p className="text-gray-500 text-sm mt-2 font-medium">Увійдіть у свій акаунт</p>
        </div>
        ...
        <p className="mt-8 text-sm text-gray-500 text-center">Немає акаунта? <Link href="/register" className="text-gray-900 font-semibold hover:underline">Зареєструватися</Link></p>
      </div>
    </div>
  );
}
