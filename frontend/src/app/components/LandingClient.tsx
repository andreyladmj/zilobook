...
const FITNESS_EVENTS: CalendarEvent[] = [
  { day: 0, start: 8, duration: 1.5, title: "Alex (Legs)", meta: "Individual", type: "individual", prepaid: true },
  { day: 0, start: 18, duration: 1, title: "CrossFit", meta: "12/15 joined", type: "group" },
  {
    day: 1, start: 14, duration: 1.5, title: "Kids MMA", meta: "Trainer A", type: "group", overlapIndex: 1, overlapTotal: 2,
    showTooltip: true,
    details: [
      { label: "Level", value: "Beginner" },
      { label: "Booked", value: "8 / 10" },
      { label: "Drop-in", value: "$40" }
    ]
  },
  { day: 1, start: 14, duration: 1.5, title: "Adult Box", meta: "Trainer B", type: "individual", overlapIndex: 0, overlapTotal: 2 },
  { day: 1, start: 19, duration: 1.5, title: "MMA", meta: "8/10 joined", type: "group" },
  { day: 2, start: 18, duration: 1, title: "TRX", meta: "5/8 joined", type: "group" },
  { day: 2, start: 20, duration: 1, title: "Mike T. (Chest)", meta: "Individual", type: "individual" },
  { day: 3, start: 17, duration: 1.5, title: "Stretching", meta: "14/20 joined", type: "group" },
  { day: 4, start: 18, duration: 1.5, title: "CrossFit", meta: "Full", type: "group" },
  { day: 4, start: 20, duration: 1, title: "James W.", meta: "Individual", type: "individual" },
  { day: 5, start: 9, duration: 2, title: "Saturday Bootcamp", meta: "20/25 joined", type: "group" },
  { day: 5, start: 11.5, duration: 1, title: "Sarah C. (Cardio)", meta: "Individual", type: "individual" },
  { day: 6, start: 10, duration: 1.5, title: "Stretching", meta: "10/20 joined", type: "group" },
];

const BEAUTY_EVENTS: CalendarEvent[] = [
  { day: 0, start: 10, duration: 4, title: "Hair Coloring", meta: "Balayage", type: "service" },
  { day: 0, start: 15, duration: 2, title: "Nails", meta: "Hard Gel", type: "service", prepaid: true },
  { day: 1, start: 12, duration: 1, title: "Haircut", meta: "Womens Trim", type: "service" },
  { day: 1, start: 18, duration: 2, title: "Nails", meta: "Extension", type: "service" },
  { day: 2, start: 9, duration: 3, title: "Hair Coloring", meta: "Root Touch-up", type: "service" },
  { day: 3, start: 14, duration: 2, title: "Nails", meta: "Spa Pedicure", type: "service" },
  { day: 4, start: 18, duration: 2, title: "Nails", meta: "Art & Extension", type: "service", prepaid: true },
  { day: 5, start: 10, duration: 4, title: "Full Transformation", meta: "Color & Cut", type: "service" },
  { day: 6, start: 11, duration: 2, title: "Anna R. (Nails)", meta: "Standard Gel", type: "service", isVip: true },
];

const AUTO_EVENTS: CalendarEvent[] = [
  { day: 0, start: 9, duration: 4, title: "Timing Belt Replacement", meta: "Toyota Camry", type: "service" },
  { day: 0, start: 14, duration: 2, title: "Oil Exchange", meta: "Honda Civic", type: "service" },
  { day: 1, start: 8, duration: 9, title: "Engine Rebuild", meta: "Ford F150", type: "service" },
  { day: 2, start: 10, duration: 2, title: "Technical Inspection", meta: "BMW 3 Series", type: "service", prepaid: true },
  { day: 3, start: 14, duration: 4, title: "Suspension Repair", meta: "Audi A4", type: "service" },
  { day: 4, start: 9, duration: 2, title: "Tire Change", meta: "All 4 tires", type: "service" },
  { day: 4, start: 12, duration: 3, title: "Brake Pads + Rotors", meta: "Mazda CX-5", type: "service" },
  { day: 5, start: 9, duration: 2, title: "Oil Exchange", meta: "Subaru Outback", type: "service" },
];
...
const THEMES = {
  fitness: {
    ...
    title: "Focus on the rep.",
    subtitle: "We handle the rest.",
    desc: "Give clients a stunning booking experience. Say goodbye to late-night DMs with automated calendar sync.",
  ...
  beauty: {
    ...
    accent: "bg-pink-500",
    title: "Your salon,",
    subtitle: "perfectly managed.",
    desc: "A gorgeous booking link for your bio. Let clients book effortlessly while you collect deposits.",
  ...
  service: {
    ...
    accent: "bg-blue-600",
    title: "Keep their cars running.",
    subtitle: "We'll keep your shop full.",
    desc: "Automate mechanic bays and service station appointments. Prevent empty bays and missed maintenance.",
  ...
  return (
    <div className={clsx("flex flex-col min-h-screen font-sans transition-colors duration-500", theme.bg, theme.text)}>
                            ...
                            return (
                               ...
                               >
                                 <div className="flex items-start justify-between gap-1 w-full relative z-10 hidden sm:flex">
                                    ...
                                    {ev.prepaid && (
                                       <span className="text-[9px] uppercase tracking-wider font-extrabold px-1.5 rounded border border-current opacity-60 whitespace-nowrap hidden md:inline-block">Paid</span>
                                    )}
                                 </div>
      ...
      <footer className={clsx("border-t py-8 text-center text-sm opacity-40 font-medium", activeThemeId === "beauty" ? "border-pink-200" : "border-gray-800")}>
        Zilobook — Booking for independent professionals
      </footer>
    </div>
  );
}
